...
import com.example.week12.ui.viewmodel.HomeUiState
import com.example.week12.ui.viewmodel.HomeViewModel
...
fun HomeStatus(
    ...
    when(homeUiState){
        ...
        is HomeUiState.Success ->
            if (homeUiState.mahasiwa.isEmpty()){
                return Box(modifier = modifier.fillMaxSize(), contentAlignment = Alignment.Center){
                    Text(text = "Tidak ada data Kontak")
                }
            } else{
                MhsLayout(
                    mahasiswa = homeUiState.mahasiwa, modifier = modifier.fillMaxWidth(),
                    onDetailClick = {
