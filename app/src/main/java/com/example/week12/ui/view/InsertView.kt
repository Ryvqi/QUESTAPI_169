...
import com.example.week12.ui.viewmodel.InserUiState
import com.example.week12.ui.viewmodel.InsertUiEvent
import com.example.week12.ui.viewmodel.InsertViewModel
...
fun EntryMhsScreen(
    ...
    Scaffold(
        ...
        EntryBody(
            inserUiState = viewModel.uiState,
...
fun EntryBody(
    ...
    Column(
        ...
        FormInput(
            insertUiEvent = inserUiState.inserUiEvent,
